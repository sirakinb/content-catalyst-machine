  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-brand-gradient-start to-brand-gradient-end">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 bg-gradient-to-r from-brand-purple to-brand-pink bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {problems.map((problem) => (
            ...
            >
              <problem.icon className="w-12 h-12 mx-auto mb-6 text-brand-purple" />
